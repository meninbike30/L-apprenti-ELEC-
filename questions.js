    ...
    topics: [
      {
        ...
        questions: [
          ...
          { q: "Quelles sont les 3 zones de protection d'un système d'alarme intrusion ?", options: ["Haute, moyenne, basse", "Périphérique, périmétrique, volumétrique", "Nord, sud, centrale", "Jour, nuit, absence"], correct: 1, exp: "On distingue la protection périphérique (approche), périmétrique (enveloppe du bâtiment/ouvrants) et volumétrique (intérieur des volumes)." },
          ...
          { q: "Qu'est-ce que l'autoprotection (AP) d'un détecteur ou d'une centrale ?", options: ["Un mode économie d'énergie", "Un contact anti-arrachement/anti-ouverture (tamper) qui déclenche une alerte en cas de sabotage", "Un fusible de protection électrique", "Un revêtement anti-humidité"], correct: 1, exp: "L'autoprotection surveille l'intégrité physique du matériel (ouverture du capot, arrachement du support) pour prévenir tout sabotage." },
          { q: "Quelle différence existe-t-il entre une sirène extérieure autoalimentée et une sirène simple (haut-parleur) ?", options: ["Aucune, elles sont identiques", "La sirène autoalimentée dispose de sa propre batterie et de son autoprotection, contrairement à la sirène simple alimentée uniquement par la centrale", "La sirène simple est toujours plus puissante", "La sirène autoalimentée ne peut pas être installée en extérieur"], correct: 1, exp: "La sirène autoalimentée intègre une batterie et une autoprotection, ce qui la rend autonome même si l'alimentation ou le câble est coupé." }
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          ...
          { q: "Qu'est-ce que le système VIGIK ?", options: ["Un protocole domotique radio", "Un système d'accès normalisé utilisé notamment par les prestataires de service (La Poste, EDF...) pour accéder aux parties communes", "Un type de détecteur incendie", "Une norme de câblage RJ45"], correct: 1, exp: "VIGIK permet l'accès temporaire et tracé des professionnels habilités aux parties communes d'immeubles." },
          { q: "Quelle est la différence entre une gâche électrique et une ventouse magnétique ?", options: ["Aucune, ce sont des synonymes", "La gâche électrique déverrouille un pêne mécanique, la ventouse magnétique retient la porte par un électroaimant", "La ventouse ne fonctionne que sur les portails", "La gâche est toujours sans fil"], correct: 1, exp: "La gâche électrique agit sur le mécanisme de la serrure, tandis que la ventouse magnétique maintient la porte fermée par attraction magnétique directe." },
          { q: "Pourquoi place-t-on une diode de roue libre (ou une varistance) en parallèle d'une gâche électrique ?", options: ["Pour augmenter la tension", "Pour absorber la surtension générée à la coupure de la bobine et protéger le circuit de commande", "Pour éclairer la gâche", "Pour mesurer le courant consommé"], correct: 1, exp: "La diode de roue libre (en continu) ou la varistance (en alternatif) écrête le pic de tension créé par la self de la gâche à la coupure, protégeant les composants électroniques." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Quelle norme européenne encadre la limitation des forces pour les portails motorisés ?", options: ["NF C 15-100", "EN 12453", "EN 13241-1 uniquement", "EN 60335-2-103 uniquement"], correct: 1, exp: "La norme EN 12453 fixe les exigences de sécurité et de limitation d'effort pour les motorisations de portails." },
          ...
          { q: "Quels accessoires complémentaires sont recommandés sur un portail battant automatisé donnant sur la voie publique ?", options: ["Aucun accessoire n'est utile", "Feu clignotant, cellules photoélectriques et éventuellement un marquage au sol", "Uniquement une sonnette", "Un limiteur de tension"], correct: 1, exp: "Le feu clignotant signale le mouvement, les cellules détectent un obstacle, et le marquage au sol informe les usagers de la zone de débattement." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Comment la motorisation d'un portail coulissant doit-elle être fixée ?", options: ["Simplement posée sur le sol sans fixation", "Solidement fixée au sol ou sur un châssis métallique, à bonne hauteur par rapport à la crémaillère", "Fixée uniquement sur le portail lui-même", "Suspendue en hauteur sur un portique"], correct: 1, exp: "Une fixation solide au sol ou sur châssis, correctement positionnée par rapport à la crémaillère, garantit un engrènement correct et durable." },
          ...
          { q: "Comment les systèmes de motorisation de portails évitent-ils le coincement ou l'écrasement des utilisateurs ?", options: ["Ils n'intègrent aucune protection", "Par un couple de force réglable ou établi en usine, limitant l'effort exercé", "En augmentant la vitesse de fermeture", "En supprimant les cellules de sécurité"], correct: 1, exp: "La limitation du couple moteur, réglable ou calibré en usine, permet de détecter un obstacle et de limiter l'effort exercé sur celui-ci." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Depuis quand la norme EN 13241-1 est-elle obligatoire pour les portes de garage motorisées ?", options: ["Depuis le 1er janvier 2000", "Depuis le 1er mai 2005", "Depuis le 1er mai 2010", "Elle n'est pas obligatoire"], correct: 1, exp: "La norme européenne EN 13241-1 est obligatoire depuis le 1er mai 2005 pour les portes et portails." },
          { q: "Quel point faut-il obligatoirement vérifier avant l'installation d'une motorisation de porte de garage ?", options: ["Uniquement la couleur de la porte", "La hauteur sous linteau disponible entre le point le plus haut de la porte et le plafond", "Le prix du matériel uniquement", "Rien n'est à vérifier"], correct: 1, exp: "Une hauteur sous linteau minimale est nécessaire pour installer le moteur, cette valeur varie selon la marque." },
          { q: "Que faut-il prévoir si la porte de garage motorisée est le seul accès à la propriété et ne possède pas de portillon ?", options: ["Rien de particulier", "Un déverrouillage extérieur et des accessoires d'accès complémentaires", "Une deuxième porte de garage", "Un limiteur de tension"], correct: 1, exp: "Sans portillon, un déverrouillage extérieur est indispensable pour permettre l'accès en cas de coupure de courant ou de panne." }
        ]
      },
      {
    ...
    topics: [
      {
        ...
        questions: [
          ...
          { q: "Parmi Z-Wave, Zigbee, X3D, IO-homecontrol et KNX, lesquels sont des protocoles domotiques radio ?", options: ["Aucun, ce sont tous des protocoles filaires", "Z-Wave, Zigbee, X3D et IO-homecontrol", "Uniquement KNX", "Uniquement Zigbee"], correct: 1, exp: "Z-Wave, Zigbee, X3D et IO-homecontrol sont des protocoles radiofréquence, alors que KNX est un protocole filaire (bus)." },
          { q: "Qu'est-ce que le CPL (Courant Porteur en Ligne) en domotique ?", options: ["Un protocole radio longue portée", "Une technologie qui fait transiter l'information sur le réseau électrique existant", "Un type de câble RJ45", "Un mode de chauffage"], correct: 1, exp: "Le CPL superpose un signal de communication au réseau 230V existant, évitant de tirer un câble dédié." },
          { q: "Quelle est la longueur maximale généralement admise pour un bus KNX principal ?", options: ["100 m", "1000 m au total, avec des segments limités (350 m entre alimentation et périphérique, 700 m entre deux alimentations)", "10 m", "Aucune limite"], correct: 1, exp: "Le bus KNX impose des limites de longueur : 1000 m de câble total par ligne, 350 m maximum entre une alimentation et un composant, 700 m entre deux alimentations." },
          { q: "Quelle est la différence fondamentale entre une installation domotique en mode radio et en mode filaire (bus) ?", options: ["Aucune différence", "Le radio évite le câblage mais peut subir des perturbations, le filaire est plus fiable mais nécessite un câble bus dédié", "Le filaire ne peut piloter que l'éclairage", "Le radio nécessite toujours une box internet"], correct: 1, exp: "Le choix entre radio et filaire dépend du contexte (rénovation vs neuf), de la fiabilité recherchée et de la possibilité de tirer un câble bus." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Qu'est-ce que le DTI dans une installation de communication ?", options: ["Un Dispositif de Test Individuel", "Le Dispositif de Terminaison Intérieure, point de démarcation entre le réseau public et l'installation privée", "Un type de disjoncteur", "Une norme de câblage RJ45"], correct: 1, exp: "Le DTI matérialise la limite entre le réseau de l'opérateur et le câblage intérieur du logement." },
          { q: "Que permet un quadrupleur dans un tableau de communication ?", options: ["De sertir 4 câbles RJ45 en même temps", "De répartir un signal (ex. TV) vers plusieurs prises à partir d'une seule arrivée", "De protéger contre la foudre", "D'alimenter le tableau en 230V"], correct: 1, exp: "Le quadrupleur distribue un signal reçu vers plusieurs sorties, par exemple pour desservir plusieurs prises TV depuis une seule arrivée." },
          { q: "Selon la NF C 15-100, à quelle distance maximale de l'arrivée doit se trouver la borne de terre dans la GTL ?", options: ["Moins de 50 cm, avec une liaison de section 6 mm²", "5 mètres", "Aucune contrainte de distance", "10 mètres"], correct: 0, exp: "La NF C 15-100 impose une borne de terre accessible à moins de 50 cm de l'origine de la GTL, reliée par un conducteur de 6 mm² minimum." }
        ]
      },
      {
        nom: "Câblâge RJ 45",
        questions: [
          ...
          { q: "Quelle est la différence entre la classification par Grade (UTE) et par Catégorie (ISO/EIA) pour un câblage RJ45 ?", options: ["Ce sont des synonymes stricts", "Le Grade (1 à 4) est une classification française UTE, la Catégorie est la classification internationale ISO/EIA des composants", "La catégorie ne s'applique qu'à la fibre optique", "Le grade s'applique uniquement au Wi-Fi"], correct: 1, exp: "La norme française UTE définit des Grades (1 à 4) de câblage résidentiel, tandis que la classification internationale utilise des Catégories (5e, 6, 6A...) pour les composants." },
          { q: "Quelle norme européenne régit le câblage des réseaux de communication dans les bâtiments ?", options: ["NF EN 50174", "EN 13241-1", "EN 12453", "NF C 15-100 uniquement"], correct: 0, exp: "La norme NF EN 50174 encadre la mise en œuvre du câblage des réseaux de communication." },
          { q: "Quelle est la différence entre les brochages T568A et T568B ?", options: ["Aucune différence, ils sont identiques", "Ils inversent l'ordre de deux paires de fils (vert et orange) dans le connecteur RJ45", "T568A ne fonctionne qu'en fibre optique", "T568B est réservé aux câbles blindés"], correct: 1, exp: "T568A et T568B définissent le même câblage à l'exception de l'inversion des paires orange et verte, les deux normes doivent rester cohérentes sur une même installation." }
        ]
      },
      {
        nom: "Le chauffage",
        questions: [
          ...
          { q: "Qu'est-ce qu'un Panneau Rayonnant Électrique (PRE) ?", options: ["Un convecteur simple sans régulation", "Un appareil qui chauffe une plaque qui rayonne la chaleur, offrant une sensation plus homogène que le convecteur", "Un chauffage à eau chaude uniquement", "Un système de VMC"], correct: 1, exp: "Le panneau rayonnant chauffe une face rayonnante qui diffuse une chaleur plus douce et homogène que le simple convecteur à air." },
          { q: "Quel calibre et quelle courbe de disjoncteur protège généralement un fil pilote de radiateur ?", options: ["Disjoncteur courbe C, calibre 2 A", "Disjoncteur courbe D, calibre 32 A", "Fusible 10 A", "Aucune protection n'est nécessaire"], correct: 0, exp: "Le circuit du fil pilote, qui ne véhicule qu'un signal basse puissance, est protégé par un disjoncteur courbe C de calibre 2 A maximum." },
          { q: "Que prend en compte la réglementation thermique (RT2012) via un coefficient pour le chauffage électrique à effet Joule ?", options: ["Un coefficient de conversion de 2,58 entre énergie finale et énergie primaire", "Un coefficient de conversion de 1", "Aucun coefficient n'est appliqué", "Un coefficient uniquement pour le gaz"], correct: 0, exp: "La RT2012 applique un coefficient de conversion de 2,58 pour convertir l'énergie électrique finale en énergie primaire, pénalisant le chauffage électrique par rapport à d'autres énergies." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Combien d'ordres peut transmettre un fil pilote 6 ordres, utilisé pour la gestion de l'énergie du chauffage ?", options: ["2 ordres seulement", "6 ordres : confort, éco, hors-gel, arrêt, et deux niveaux de confort intermédiaires (confort -1, confort -2)", "10 ordres", "Un seul ordre : marche/arrêt"], correct: 1, exp: "Le fil pilote 6 ordres permet une gestion fine du chauffage avec confort, confort -1, confort -2, éco, hors-gel et arrêt." },
          { q: "Qu'est-ce que la fonction dérogation (ou marche forcée) en gestion de l'énergie ?", options: ["Une coupure définitive du circuit", "La possibilité pour l'utilisateur de forcer manuellement un mode de fonctionnement en dehors de la programmation automatique", "Un mode réservé aux professionnels", "Une fonction qui augmente la puissance souscrite"], correct: 1, exp: "La dérogation permet à l'occupant de reprendre temporairement la main sur un équipement piloté automatiquement, par exemple pour forcer le chauffage en confort." },
          { q: "Quelle est la différence entre un délestage hiérarchisé et un délestage tournant ?", options: ["Aucune différence", "Le délestage hiérarchisé coupe toujours les mêmes circuits par ordre de priorité, le délestage tournant fait alterner les circuits délestés", "Le délestage tournant ne concerne que l'éclairage", "Le délestage hiérarchisé ne s'applique qu'au chauffe-eau"], correct: 1, exp: "Le délestage hiérarchisé suit un ordre de priorité fixe, alors que le délestage tournant répartit équitablement les coupures entre les circuits non prioritaires afin d'éviter de toujours désavantager le même usage." }
        ]
      },
      {
        nom: "La VMC",
        questions: [
          ...
          { q: "Qu'est-ce qu'une VMC hygroréglable (VMR) ?", options: ["Une VMC qui fonctionne uniquement en hiver", "Une VMC dont le débit varie automatiquement selon le taux d'humidité détecté dans le logement", "Une VMC sans moteur électrique", "Une VMC réservée aux bâtiments collectifs"], correct: 1, exp: "La VMC hygroréglable module son débit d'extraction en fonction du taux d'humidité mesuré, ce qui optimise la ventilation et les économies d'énergie." },
          { q: "Quel calibre et quelle courbe de disjoncteur protègent généralement le moteur d'une VMC simple flux ?", options: ["Disjoncteur courbe C, calibre 2 A maximum", "Disjoncteur courbe D, calibre 32 A", "Fusible 16 A", "Aucune protection spécifique n'est requise"], correct: 0, exp: "Le circuit dédié au moteur de VMC est protégé par un disjoncteur courbe C de calibre 2 A maximum, conformément à la NF C 15-100." },
          { q: "Quel document normatif complète la NF C 15-100 pour les installations de VMC ?", options: ["L'amendement NF C 15-100/A5", "La norme EN 12453", "La norme EN 13241-1", "Le DTU 60.1"], correct: 0, exp: "L'amendement A5 de la NF C 15-100 précise les règles d'installation électrique applicables aux VMC." }
        ]
      },
      {
        nom: "L'IRVE",
        questions: [
          ...
          { q: "Quelle loi française encadre le déploiement des infrastructures de recharge pour véhicules électriques (IRVE) ?", options: ["La loi 2015-992 relative à la transition énergétique", "La loi NF C 15-100", "La loi EN 12453", "Il n'existe aucune loi spécifique"], correct: 0, exp: "La loi n°2015-992 relative à la transition énergétique pour la croissance verte fixe notamment des obligations d'équipement en IRVE." },
          { q: "Que désignent les modes de charge 1 à 4 en IRVE ?", options: ["Des niveaux de puissance identiques", "Des configurations normalisées définissant le type de prise, la présence de protections et de communication entre le véhicule et la borne", "Uniquement la couleur du câble de recharge", "Le nombre de véhicules rechargeables simultanément"], correct: 1, exp: "Les modes 1 à 4 définissent le niveau de sécurisation et de communication de la recharge, du simple branchement sur prise domestique (mode 1) à la recharge rapide en courant continu (mode 4)." },
          { q: "Qu'est-ce qu'une prise Green'Up ?", options: ["Une prise domestique standard", "Une prise dédiée à la recharge de véhicule électrique, identifiable et raccordée à un circuit spécifique protégé", "Un connecteur Type 2 rapide", "Une prise réservée aux bornes rapides Chademo"], correct: 1, exp: "La prise Green'Up est une prise domestique renforcée, dédiée et identifiée, alimentée par un circuit spécifique dans le tableau électrique pour la recharge en mode 1 ou 2." },
          { q: "Quel type de connecteur est utilisé par les véhicules électriques de marque japonaise pour la recharge rapide en courant continu ?", options: ["Type 2", "Chademo", "Combo (CCS)", "Type 3"], correct: 1, exp: "Le connecteur Chademo, d'origine japonaise, est utilisé pour la recharge rapide en courant continu, notamment par certains constructeurs japonais." }
        ]
      },
      {
        ...
        questions: [
          ...
          { q: "Que signifient les conditions STC (Standard Test Conditions) pour un panneau photovoltaïque ?", options: ["Les conditions de test réelles sur le terrain", "Des conditions normalisées (1000 W/m², 25°C, spectre AM1.5) permettant de comparer les caractéristiques des panneaux", "Un standard de câblage électrique", "Une norme de sécurité incendie"], correct: 1, exp: "Les conditions STC servent de référence normalisée pour indiquer et comparer les performances (Pmpp, Icc, Vco...) des panneaux entre fabricants." },
          { q: "Que représentent Icc et Vco sur la fiche technique d'un panneau photovoltaïque ?", options: ["Le courant et la tension nominaux de fonctionnement", "Le courant de court-circuit et la tension à circuit ouvert, valeurs maximales mesurées dans des conditions extrêmes", "La puissance maximale et le rendement", "La capacité de stockage de la batterie associée"], correct: 1, exp: "Icc (courant de court-circuit) et Vco (tension à vide) sont les valeurs extrêmes utilisées pour dimensionner les protections et les câbles de la chaîne photovoltaïque." },
          { q: "Quel type de câble spécifique est utilisé pour le raccordement en courant continu (DC) d'une installation photovoltaïque ?", options: ["Câble H07V-U classique", "Câble PV1000-F (ou équivalent), résistant aux UV et aux intempéries", "Câble téléphonique", "Câble RJ45"], correct: 1, exp: "Le câble PV1000-F est spécifiquement conçu pour résister aux conditions extérieures (UV, température) et à la tension DC élevée du champ photovoltaïque." },
          { q: "À quoi servent les connecteurs MC4 sur une installation photovoltaïque ?", options: ["À raccorder les câbles RJ45", "À assurer un raccordement étanche et sécurisé entre les modules photovoltaïques en courant continu", "À fixer les panneaux à la toiture", "À protéger contre la foudre uniquement"], correct: 1, exp: "Les connecteurs MC4 permettent un raccordement rapide, étanche (IP67) et sécurisé des modules photovoltaïques entre eux." },
          { q: "Quelles habilitations électriques sont spécifiquement requises pour intervenir sur une installation photovoltaïque ?", options: ["Aucune habilitation particulière n'est nécessaire", "Les habilitations BP (basse tension photovoltaïque) et BR-PV", "Uniquement l'habilitation B1V", "Uniquement le CACES"], correct: 1, exp: "Les habilitations BP et BR-PV sont spécifiques aux risques particuliers du courant continu et de la présence permanente de tension côté champ photovoltaïque, même hors réseau." }
        ]
      }
    ]
  },
